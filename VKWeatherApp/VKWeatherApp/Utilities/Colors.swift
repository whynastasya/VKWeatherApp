...
enum Colors {
    ...
    static func eveningGradint(fitting weatherType: WeatherType) -> [CGColor] {
        switch weatherType {
            case .sunny, .mostlySunny, .cloudy, .snow:
                return [
                    UIColor(red: 0.00, green: 0.85, blue: 1.00, alpha: 1.0).cgColor,
                    UIColor(red: 0.00, green: 0.30, blue: 1.00, alpha: 1.0).cgColor
                ]
